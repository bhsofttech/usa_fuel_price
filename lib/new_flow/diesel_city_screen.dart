...
class DieselCityWiseScreen extends StatefulWidget {
  final String stateName;
  final String stateUrl;
  const DieselCityWiseScreen(
      {super.key, required this.stateName, required this.stateUrl});

  @override
  State<DieselCityWiseScreen> createState() => _DieselCityWiseScreenState();
}

class _DieselCityWiseScreenState extends State<DieselCityWiseScreen>
  ...
  void initState() {
    super.initState();
    analytics.logScreenView(screenName: "${widget.stateName} Gas Prices Screen");
  ...
  Widget _buildGenericCard(String title, Map<String, String> data, IconData icon,
