...
class NaturalGasListScreen extends StatelessWidget {
  final List<Map<String, String>> naturalGasPrices;
  const NaturalGasListScreen({super.key, required this.naturalGasPrices});
