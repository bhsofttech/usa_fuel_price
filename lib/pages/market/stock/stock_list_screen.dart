            ...
            child: SizedBox(
              child: Obx(() {
                ...
                final remainingStocks =
                    stockController.getStocks.skip(1).toList();
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: const BoxDecoration(
                                ...
                                border: Border(
                                  right: BorderSide(
                                      color: Color(0xFFE5E5EA), width: 0.33),
                                ),
                              ),
                              child: Row(
                                children: [
                            ...
                            Expanded(
                              child: SingleChildScrollView(
                                ...
                                child: Row(
                                  children: [
                                    _buildHeaderCell(
                                        firstStock.price, colWidth),
                                    _buildHeaderCell(
                                        firstStock.changePercent, colWidth),
                                    _buildHeaderCell(
                                        firstStock.volume, colWidth),
                                    _buildHeaderCell(
                                        firstStock.relativeVolume, colWidth),
                                    _buildHeaderCell(
                                        firstStock.marketCap, colWidth),
                                    _buildHeaderCell(
                                        firstStock.peRatio, colWidth),
                                    _buildHeaderCell(
                                        firstStock.epsDilTTM, colWidth),
                                    _buildHeaderCell(
                                        firstStock.epsDilGrowthYoY, colWidth),
                                    _buildHeaderCell(
                                        firstStock.dividendYield, colWidth),
                                    _buildHeaderCell(
                                        firstStock.sector, colWidth),
                                  ],
                                ),
                              ),
                            ),
                                    ...
                                    children: remainingStocks
                                      ...
                                      return Container(
                                        ...
                                        child: Row(
                                          children: [
                                            _buildDataCell(
                                                stock.price, colWidth, i),
                                            _buildChangeCell(
                                                stock.changePercent,
                                                colWidth,
                                                i),
                                            _buildDataCell(
                                                stock.volume, colWidth, i),
                                            _buildDataCell(stock.relativeVolume,
                                                colWidth, i),
                                            _buildDataCell(
                                            ...
                                            _buildDataCell(
                                                stock.epsDilGrowthYoY,
                                                colWidth,
                                                i),
                                            _buildDataCell(stock.dividendYield,
                                                colWidth, i),
                                            _buildDataCell(
                                                stock.sector, colWidth, i),
                                          ],
                                        ),
                                      );
                                    }).toList(),
